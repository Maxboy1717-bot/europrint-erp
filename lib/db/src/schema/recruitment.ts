...
export const vacancies = pgTable("vacancies", {
  ...
  educationLevelRu: varchar("education_level_ru", { length: 50 }),
  technicalSkills: text("technical_skills"),
  technicalSkillsRu: text("technical_skills_ru"),
  softSkills: text("soft_skills"),
  softSkillsRu: text("soft_skills_ru"),
...
export const candidates = pgTable("candidates", {
  ...
  departmentId: integer("department_id"),
  positionId: integer("position_id"),
  questionnaireResponseId: integer("questionnaire_response_id"),
  deletedAt: timestamp("deleted_at"),
  deletedBy: integer("deleted_by"),
