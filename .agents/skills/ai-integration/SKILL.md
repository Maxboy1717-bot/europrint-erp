---
name: ai-integration
description: EuroPrint AI integratsiya — Codex API, OpenAI, prognoz, anomaliya, CFO bot, director AI, recruitment AI. Trigger so'zlar: "AI", "tahlil", "prognoz", "forecast", "agent", "CFO bot", "director AI", "anomaliya", "OpenAI", "Codex API".
---
...
## Asosiy modellar
- **Codex:** `Codex-sonnet-4-20250514` (production), `Codex-opus-4-20250514` (deep analysis)
