...
- Name: zvs-coordination.spec.ts >> ZVS API — autentifikatsiyalangan >> Level-3 ZVS ariza yuborish (>5M) → level=3 qaytaradi
- Location: e2e\zvs-coordination.spec.ts:77:3
