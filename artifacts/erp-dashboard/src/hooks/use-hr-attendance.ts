...
export function useAttendance(params?: { date?: string; employeeId?: number }) {
  ...
  return useQuery({
    queryKey: ["/api/hr/attendance", params],
...
export function useAttendanceSummary() {
  return useQuery({
    queryKey: ["/api/hr/attendance/summary"],
...
export function useCheckIn() {
  ...
  return useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ["/api/hr/attendance"] }),
  });
}
...
export function useAbcResults() {
  return useQuery({
    queryKey: ["/api/hr/attendance/abc-results"],
...
export function useRunAbcAnalysis() {
  ...
  return useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ["/api/hr/attendance/abc-results"] }),
  });
}

export function useLateEmployees() {
  return useQuery({
    queryKey: ["/api/hr/attendance/late-employees"],
...
export function useMonthlyAttendanceReport(params?: { month?: string }) {
  ...
  return useQuery({
    queryKey: ["/api/hr/attendance/monthly-report", params],
