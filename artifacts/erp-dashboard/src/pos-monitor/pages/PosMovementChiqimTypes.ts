...
export const MOVEMENT_TYPES: { code: MovementTypeCode; label: string; color: string }[] = [
  { code: "EXTERNAL_OUT",      label: tLabel('common.PosMovementChiqim.tashqiChiqim', "Tashqi chiqim"),   color: "#EF4444" },
  { code: "INTERNAL_ISSUE",    label: tLabel('common.PosMovementChiqim.ichkiBerish', "Ichki berish"),     color: "#F59E0B" },
