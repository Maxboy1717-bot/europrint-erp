    ...
    <div style={{ minHeight: "100vh", background: "#F8FAFC" }}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative" }}>
          <span style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", fontSize: 14, color: "#9CA3AF" }}>
            🔍
          </span>
          <input
            style={{
        ...
        {catTabList.map(cat => (
          <button
            ...
            style={{
              ...
              color: activeCategory === cat.key ? "#1F2937" : "#9CA3AF",
              borderBottom: activeCategory === cat.key ? "2px solid #F59E0B" : "2px solid transparent",
            ...
            {Array.from({ length: 18 }).map((_, i) => (
              <div key={i} style={{
                ...
                <div style={{ padding: "10px 12px", display: "flex", flexDirection: "column", gap: 6 }}>
                  <div style={{ height: 12, borderRadius: 4, background: "#F3F4F6", width: "80%" }} />
                  <div style={{ height: 10, borderRadius: 4, background: "#F3F4F6", width: "50%" }} />
                  <div style={{ height: 16, borderRadius: 6, background: "#F3F4F6", width: "60%" }} />
                </div>
              </div>
            ))}
          </div>
