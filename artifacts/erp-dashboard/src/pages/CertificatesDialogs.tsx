  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="bg-card border-border max-w-lg p-6">
        <DialogHeader>
          <DialogTitle className="text-foreground text-xl">{t("yangiSertifikatBerish")}</DialogTitle>
          <DialogDescription className="text-muted-foreground">
            {t("kursniMuvaffaqiyatliYakunlaganXodimgaSertifikat")}
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          <div className="space-y-1">
          <Label htmlFor="employee" className="text-foreground font-semibold">{t("xodim1")}</Label>
          ...
          <div className="space-y-1">
          <Label htmlFor="course" className="text-foreground font-semibold">{t("kurs")}</Label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
          <Label htmlFor="score" className="text-foreground font-semibold">{t("yakuniyBall")}</Label>
              <Input
                id="score"
            ...
            <div className="space-y-1">
          <Label htmlFor="bonus" className="text-foreground font-semibold">{t("bonusMiqdori")}</Label>
              <Input
                id="bonus"
          ...
          <div className="space-y-1">
          <Label htmlFor="expiresAt" className="text-foreground font-semibold">{t("amalQilishMuddati")}</Label>
            <Input
              id="expiresAt"
