    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogTrigger asChild>
        <Button className="bg-primary text-white rounded-lg px-5 py-2.5 text-sm font-semibold gap-2" data-testid="button-add-api">
          <Plus className="h-4 w-4" />{t("apiQoshish")}
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-md bg-card border-none p-6">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label className="text-muted-foreground">{t("platforma1")}</Label>
          ...
          <div className="space-y-1.5">
            <Label className="text-muted-foreground">{t("apiSecret")}</Label>
          ...
          <div className="space-y-1.5">
            <Label className="text-muted-foreground">{t("webhookSecret")}</Label>
          ...
          <div className="flex items-center gap-3">
            ...
            <Label className="text-foreground font-medium">{t("active")}</Label>
          </div>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogTrigger asChild>
        <Button className="bg-primary text-white rounded-lg px-5 py-2.5 text-sm font-semibold gap-2" data-testid="button-create-setting">
          <Plus className="h-4 w-4" />{t("yangiSozlama")}
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-lg bg-card border-none p-6">
        <DialogHeader>
          <DialogTitle className="text-foreground font-bold">{t("yangiSozlama")}</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          <div className="space-y-1.5">
          ...
          <Button onClick={onSubmit} disabled={!form.key || isSubmitPending} className="w-full bg-primary text-white font-bold h-11" data-testid="button-submit-setting">{t("Yaratish")}</Button>
        </div>
      </DialogContent>
    </Dialog>
  );
