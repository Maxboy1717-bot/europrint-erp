...
const AGENT_CARDS = [
  ...
  { code: 'hr',          name: 'HR Performance',    icon: '👥', color: '#EF4444', endpoint: '/api/agents/hr/performance/1' },
  ...
  { code: 'iot',         name: 'IoT/Kamera',        icon: '📡', color: '#22C55E', endpoint: '/api/agents/iot/sensor/MACHINE_001' },
