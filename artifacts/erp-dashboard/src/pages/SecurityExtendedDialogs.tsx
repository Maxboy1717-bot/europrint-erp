  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-card border-border p-6">
        <DialogHeader>
          <DialogTitle className="text-foreground">{t("mehmonRoyxatdanOtkazish")}</DialogTitle>
        </DialogHeader>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
          <Label className="text-foreground">{t("ismFamiliya")}</Label>
              <Input
                {...form.register("name")}
            ...
            <div className="space-y-1">
          <Label className="text-foreground">{t("tashkilot")}</Label>
              <Input
          ...
          <div className="space-y-1">
          <Label className="text-foreground">{t("tashrifMaqsadi")}</Label>
            <Input
              {...form.register("purpose")}
              placeholder={t("uchrashuvYetkazibBerish")}
              className="bg-muted/40 border-border"
            />
          </div>
          <DialogFooter>
