      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent className="space-y-0 divide-y">
            ...
            <InfoRow label="Ustuvorlik" value={<Badge variant="outline">P{overview.priority}</Badge>} />
        ...
        <Card>
          ...
          <CardContent className="space-y-0 divide-y">
            ...
            {kpi.leadTimeDays != null && <InfoRow label="Davom etish" value={`${kpi.leadTimeDays} kun`} />}
          </CardContent>
        </Card>
      </div>
