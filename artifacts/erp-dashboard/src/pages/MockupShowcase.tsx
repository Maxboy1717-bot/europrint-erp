    ...
    <div className="ep-content space-y-6">
      <div>
        ...
        <p className="text-sm text-[var(--ep-muted)] mt-1">
          SmartHR mockup uslubidagi barcha qayta ishlatiladigan komponentlar
        </p>
      </div>

      {/* Welcome banner */}
      <section>
        <h2 className="text-sm font-semibold uppercase text-[var(--ep-muted)] mb-2">1. Welcome Banner</h2>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <KpiCardMockup icon={<UserX className="h-5 w-5" />} iconColor="red" label="Bugun yo'q" value={3} link="Davomat" />
          <KpiCardMockup icon={<Briefcase className="h-5 w-5" />} iconColor="purple" label="Vakant" value={12} link="Recruiting" />
          <KpiCardMockup icon={<TrendingUp className="h-5 w-5" />} iconColor="pink" label="Attrition" value="3.2%" link="Tahlil" />
          <KpiCardMockup icon={<Calendar className="h-5 w-5" />} iconColor="dark" label="Ta'til" value={7} link="Approve" />
          <KpiCardMockup icon={<CheckCircle2 className="h-5 w-5" />} iconColor="green" label="Smenada" value={139} link="Smena" />
        </div>
      </section>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <StatusPill variant="warning">Kutilmoqda</StatusPill>
          <StatusPill variant="info">Yangi</StatusPill>
          <StatusPill variant="primary">Birinchi</StatusPill>
          <StatusPill variant="purple">Premium</StatusPill>
          <StatusPill variant="pink">VIP</StatusPill>
          <StatusPill variant="dark">Arxiv</StatusPill>
        </div>
      </section>
      ...
      {/* Avatars */}
      <section>
        <h2 className="text-sm font-semibold uppercase text-[var(--ep-muted)] mb-2">5. Avatars</h2>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <CardMockup
            ...
            action={<button className="text-xs text-[var(--ep-primary)]">Hammasini ko'rish →</button>}
          >
              ...
              {['Sardor Karimov', 'Aziz Mirzayev', 'Madina Ali'].map((name, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-[var(--ep-muted)]">2 kun oldin qo'shildi</div>
                  </div>
                  <StatusPill variant="success">Faol</StatusPill>
                </div>
              ))}
          ...
          <CardMockup title="Bugungi smena">
            <div className="space-y-2">
              <ScheduleCard
                tag="Ish"
                tagColor="orange"
                title="Ofset ishlab chiqarish"
                time="08:00 - 17:00"
                location="Ofset sex"
                attendees={5}
              />
      ...
      {/* Special Cards */}
      <section>
        <h2 className="text-sm font-semibold uppercase text-[var(--ep-muted)] mb-2">7. Special Gradient Cards</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="card-dark-grad">
            <div className="text-3xl font-bold">154</div>
            <div className="text-xs opacity-80 mt-1">Faol xodimlar</div>
      ...
      <section>
        <h2 className="text-sm font-semibold uppercase text-[var(--ep-muted)] mb-2">8. Performance Highlight</h2>
        <div className="perf-highlight">
          <Clock className="h-5 w-5 text-[var(--ep-primary)]" />
          <div>
            <div className="font-semibold text-sm">Bu oyda samaradorlik</div>
            <div className="text-xs text-[var(--ep-muted)]">+12% o'tgan oyga nisbatan</div>
          </div>
      ...
      {/* Pill buttons */}
      <section>
        <h2 className="text-sm font-semibold uppercase text-[var(--ep-muted)] mb-2">9. Pill Buttons</h2>
        <div className="flex flex-wrap gap-2">
          <button className="pill-btn"><Calendar className="h-3 w-3" /> Bugun</button>
          <button className="pill-btn"><Calendar className="h-3 w-3" /> Hafta</button>
          <button className="pill-btn"><Calendar className="h-3 w-3" /> Oy</button>
          <button className="pill-btn">Hammasi</button>
        </div>
      </section>
