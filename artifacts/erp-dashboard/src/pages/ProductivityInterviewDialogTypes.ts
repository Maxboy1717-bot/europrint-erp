...
export const MOTIVATION_LEVELS = [
  {
    level: 4,
    label: "Burch",
    description: tLabel('common.ProductivityInterviewDialog.masuliyatVaMajburiyatAsosidaIshlaydi', "Mas'uliyat va majburiyat asosida ishlaydi. Jamiyat va kompaniya oldidagi burch tuyg'usi."),
    color: "border-blue-500/60 bg-blue-500/10 text-blue-300",
    icon: "🏛",
  },
  {
    level: 3,
    label: tLabel('common.ProductivityInterviewDialog.etiqod', "E'tiqod"),
    description: tLabel('common.ProductivityInterviewDialog.ishigaIshonadiMissiyagaMosHarakat', "Ishiga ishonadi, missiyaga mos harakat qiladi. Ichki qadriyatlar va g'oyaviy motivatsiya."),
  ...
  },
  {
    level: 2,
    label: "Manfaat",
    description: tLabel('common.ProductivityInterviewDialog.natijaVaMukofotUchunIshlaydi', "Natija va mukofot uchun ishlaydi. O'sish imkoniyatlari, karyera va professional rivojlanish."),
  ...
  },
  {
    level: 1,
    label: "Pul",
    description: tLabel('common.ProductivityInterviewDialog.asosanModdiyManfaatUchunIshlaydi', "Asosan moddiy manfaat uchun ishlaydi. Ish haqining muhimligi birinchi o'rinda."),
