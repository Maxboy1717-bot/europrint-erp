          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                ...
                <span className="font-bold text-green-600">{formatCurrency(data?.cashFlow?.inflows || 0)}</span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <span className="font-bold text-red-600">{formatCurrency(data?.cashFlow?.outflows || 0)}</span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <span className={`font-bold ${(data?.cashFlow?.netCashFlow || 0) >= 0 ? "text-green-600" : "text-red-600"}`}>
            ...
            <div className="space-y-4">
              <div className="p-3 rounded-lg border">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-medium text-green-600">Debitorlik (AR)</span>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600">-{formatShortCurrency(data?.arMovement?.collected || 0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Yangi:</span>
                    <span className="text-blue-600">+{formatShortCurrency(data?.arMovement?.newInvoices || 0)}</span>
                  </div>
              ...
              <div className="p-3 rounded-lg border">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-medium text-red-600">Kreditorlik (AP)</span>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600">-{formatShortCurrency(data?.apMovement?.paid || 0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Yangi:</span>
                    <span className="text-red-600">+{formatShortCurrency(data?.apMovement?.newBills || 0)}</span>
                  </div>
                  <div className="flex justify-between font-medium">
                    <span>Yopilish:</span>
