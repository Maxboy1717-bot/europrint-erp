...
export function AssetsTab({
  ...
  return (
    <TabsContent value="assets" className="space-y-4 mt-4">
      {assetSummary && Object.keys(assetSummary.byType).length > 0 && (
          ...
          <div className="flex flex-wrap gap-3 items-end">
            ...
            <div className="w-[160px]">
              ...
              <Select value={typeFilter} onValueChange={setTypeFilter}>
                <SelectTrigger data-testid="select-type-filter"><SelectValue placeholder={tCommon("all")} /></SelectTrigger>
                <SelectContent>
            ...
            <div className="w-[150px]">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger data-testid="select-status-filter"><SelectValue placeholder={tCommon("all")} /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">{tCommon("all")}</SelectItem>
