...
export function getAssetTypeIcon(type: string) {
  switch (type) {
    case "it_equipment": return <Laptop className="h-4 w-4 text-blue-500" />;
    case "vehicle": return <Car className="h-4 w-4 text-green-500" />;
    case "building": return <Building2 className="h-4 w-4 text-purple-500" />;
    case "furniture": return <Armchair className="h-4 w-4 text-amber-500" />;
...
export function getConditionBadge(condition: string, t: TFn) {
  switch (condition) {
    case "excellent": return <Badge variant="outline" className="bg-green-500/20 text-green-500 border-green-500/40">{t(conditionLabels[condition])}</Badge>;
    case "good": return <Badge variant="outline" className="bg-blue-500/20 text-blue-500 border-blue-500/40">{t(conditionLabels[condition])}</Badge>;
    case "fair": return <Badge variant="outline" className="bg-amber-500/20 text-amber-500 border-amber-500/40">{t(conditionLabels[condition])}</Badge>;
    case "poor": return <Badge variant="outline" className="bg-red-500/20 text-red-500 border-red-500/40">{t(conditionLabels[condition])}</Badge>;
...
export function getAssetStatusBadge(status: string, t: TFn) {
  switch (status) {
    case "active": return <Badge variant="outline" className="bg-green-500/20 text-green-500 border-green-500/40">{t(assetStatusLabels[status])}</Badge>;
    ...
    case "under_repair": return <Badge variant="outline" className="bg-amber-500/20 text-amber-500 border-amber-500/40">{t(assetStatusLabels[status])}</Badge>;
...
export function getMaintenanceStatusBadge(status: string, t: TFn) {
  switch (status) {
    case "scheduled": return <Badge variant="outline" className="bg-blue-500/20 text-blue-500 border-blue-500/40">{t(maintenanceStatusLabels[status])}</Badge>;
    case "in_progress": return <Badge variant="outline" className="bg-amber-500/20 text-amber-500 border-amber-500/40">{t(maintenanceStatusLabels[status])}</Badge>;
    case "completed": return <Badge variant="outline" className="bg-green-500/20 text-green-500 border-green-500/40">{t(maintenanceStatusLabels[status])}</Badge>;
