    ...
    <Card>
      ...
      <CardContent className="p-3 pt-1 space-y-3">
        <div>
          ...
          <Input data-testid="input-issue-barcode" placeholder="Barcode skanerlang" value={formData.barcodeId} onChange={(e) => setFormData({ ...formData, barcodeId: e.target.value })} />
        </div>
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div>
            <Label className="text-xs">Ish buyurtmasi</Label>
