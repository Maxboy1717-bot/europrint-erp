  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md rounded-xl border-none shadow-lg p-6">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold tracking-tight">{t("barcodeMalumoti")}</DialogTitle>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-muted/60 rounded-xl p-4 border border-border">
              <p className="text-xs font-black uppercase tracking-widest text-muted-foreground mb-1">{t("quantity")}</p>
            ...
            <div className="bg-muted/60 rounded-xl p-4 border border-border">
              <p className="text-xs font-black uppercase tracking-widest text-muted-foreground mb-1">{t("status28")}</p>
          ...
          <div className="space-y-3 px-2">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground font-medium">{t("ombor1")}</span>
              <span className="font-bold">{result.warehouseName || "Noma'lum"}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground font-medium">{t("lot1")}</span>
              <span className="font-bold">{result.lotNumber || "—"}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground font-medium">{t("qabulSanasi")}</span>
