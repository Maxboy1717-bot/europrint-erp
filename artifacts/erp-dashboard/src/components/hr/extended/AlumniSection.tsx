  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        {([
          { l: "Jami Alumni", v: alumniStats.total, c: "text-blue-600", i: Users },
          { l: "Qaytgan xodimlar", v: alumniStats.returned, c: "text-green-600", i: CheckCircle2 },
          { l: "Loyihalardagi ishtirok", v: alumniStats.collaborations, c: "text-orange-600", i: FileText },
        ]).map(s => (
      ...
      <Card>
        ...
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              {alumniList.length === 0 ? (
                <TableRow><TableCell colSpan={5} className="text-center py-8 text-muted-foreground">Alumni ma'lumotlari yo'q</TableCell></TableRow>
                ...
                <TableRow key={al.id}>
                  ...
                  <TableCell>
                    {al.isReturned ? <Badge className="bg-green-100 text-green-700 hover:bg-green-100">Qaytgan</Badge> : <Badge variant="outline">Alumni</Badge>}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
