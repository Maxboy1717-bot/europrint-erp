import { LayoutDashboard, X,
  ...
  tz08: {
    ...
    items: [
      ...
      { title: "Rulon Ombori", url: "warehouse/hub/RM-ROLLS", icon: ScrollText },
      { title: "Tayyor Mahsulot", url: "warehouse/hub/FG-MAIN", icon: Boxes },
      { title: "Yarim Tayyor", url: "warehouse/hub/WIP-MAIN", icon: Factory },
      { title: "Brak Ombori", url: "warehouse/hub/SCRAP-MAIN", icon: Trash2 },
      { title: "Karantin Ombori", url: "warehouse/hub/QC-HOLD", icon: ShieldCheck },
      { title: "Asbob Uskuna", url: "warehouse/hub/TOOL-MAIN", icon: Wrench },
      { title: "Xo'jalik Ombori", url: "warehouse/hub/MRO-MAIN", icon: Hammer },
      { title: "MRO Ombori", url: "warehouse/hub/MRO-STORE", icon: Settings },
      ...
      { title: "ISHLAB CHIQARISH BALANSI", url: "", icon: Scale, separator: true },
      ...
      { title: "Ombor KPI", url: "wms/kpi", icon: Target },
      { title: "MATERIAL BALANS", url: "", icon: Layers, separator: true },
  ...
  tz11: {
    ...
    items: [
      ...
      { title: "Org Jadval", url: "org-chart", icon: Network },
      ...
      { title: "MAOSH", url: "", icon: DollarSign, separator: true },
      ...
      { title: "Intizom V2", url: "discipline", icon: ShieldCheck },
      ...
      { title: "360° Kunlik Baholash", url: "hr/peer-review", icon: Star },
