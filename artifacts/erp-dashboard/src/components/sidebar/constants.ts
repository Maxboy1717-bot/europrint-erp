import { LayoutDashboard, X,
  ...
  tz01: {
    ...
    items: [
      ...
      { title: "SD Umumiy Ko'rinish", url: "sd/dashboard/overview", icon: BarChart3 },
      { title: "SD Kvota Dashboard", url: "sd/dashboard/quota", icon: Target },
      ...
      { title: "Yetkazib Berishlar", url: "sd/deliveries", icon: Truck },
      ...
      { title: "Voronka Sozlamalari", url: "crm/funnel-settings", icon: Filter },
      { title: "CRM Sozlamalari", url: "crm/settings", icon: Settings },
    ]
  },
  tz02: {
    title: "Marketing",
  ...
  tz04: {
    ...
    items: [
      ...
      { title: "Jarayon Ichidagi QC", url: "qc/in-process", icon: ClipboardCheck },
      ...
      { title: "Sabablar Katalogi", url: "qc/root-causes", icon: GitBranch },
  ...
  tz06: {
    ...
    items: [
      ...
      { title: "PP Uskuna Katalogi", url: "pp/equipment", icon: Wrench },
      { title: "KUNLIK / HAFTALIK / OYLIK", url: "", icon: Calendar, separator: true },
      { title: "Rejalashtirish", url: "planning", icon: Calendar },
      { title: "Haftalik Reja", url: "pp/weekly-plan", icon: CalendarDays },
      { title: "Stanok Navbati", url: "pp/queue", icon: ListOrdered },
      { title: "Sabab Kodlari", url: "pp/reason-codes", icon: Tag },
      ...
      { title: "AI Talab Prognozi", url: "ai/forecast", icon: TrendingUp },
      { title: "MRP Matritsa", url: "pp/mrp", icon: Grid3X3 },
      { title: "CRP (Quvvat Talabi)", url: "pp/crp", icon: Gauge },
  ...
  tz08: {
    ...
    items: [
      ...
      { title: "Ombor Zonalari", url: "wms/zones", icon: Map },
      { title: "Tayyor mahsulot ombori", url: "warehouse/finished-goods", icon: PackageCheck },
      { title: "Import — Yo'lda kuzatuv", url: "wms/in-transit", icon: Truck },
      ...
      { title: "Tovar Chiqim", url: "wms/goods-issue", icon: PackageCheck },
      { title: "INVENTAR / HISOBOT", url: "", icon: ClipboardList, separator: true },
      { title: "Inventarizatsiya", url: "wms/inventory", icon: ClipboardCheck },
      { title: "Tafovut Tasdiqlash", url: "wms/variance-approval", icon: ShieldAlert },
      ...
      { title: "Rulon Balans (FIFO)", url: "warehouse/rolls", icon: RotateCcw },
      { title: "Ombor KPI Hub", url: "wms/kpi-hub", icon: Gauge },
      { title: "Hisobotlar Katalogi", url: "wms/reports", icon: FileText },
      { title: "Hisobotlar (Stock/ABC/Aging)", url: "warehouse/reports", icon: BarChart3 },
      { title: "Material Balans", url: "wms/material-balance", icon: Scale },
      { title: "EOQ Kalkulyator", url: "wms/eoq", icon: Calculator },
      { title: "Audit Log", url: "wms/audit-log", icon: ScrollText },
  ...
  tz09: {
    ...
    items: [
      ...
      { title: "Faktura Tekshiruvi (3-tomonlama)", url: "integration/invoice-verification", icon: FileCheck },
  ...
  tz10: {
    ...
    items: [
      ...
      { title: "GL Provodka Monitor", url: "integration/gl-posting", icon: BookOpen },
      ...
      { title: "Byudjet Og'ishi (Variance)", url: "finance/variance", icon: TrendingDown },
      { title: "Narx Pog'onalari", url: "finance/pricing-tiers", icon: Tag },
      ...
      { title: "Break-even Kalkulyator", url: "finance/break-even", icon: Calculator },
      ...
      { title: "CFO Konfiguratsiya", url: "cfo/config", icon: Settings },
  ...
  tz11: {
    ...
    items: [
      ...
      { title: "Xato Katalogi", url: "org-structure/error-catalog", icon: AlertTriangle },
      { title: "Savollar Banki (AI-imtihon)", url: "org-structure/question-bank", icon: FileQuestion },
      { title: "Lavozim Tavsiflari", url: "hr/job-descriptions", icon: Briefcase },
      ...
      { title: "Recruiter KPI", url: "hr/recruiter-kpi", icon: Target },
      { title: "Ichki Vakansiyalar", url: "hr/internal-jobs", icon: UserPlus },
      ...
      { title: "Bildirishnoma Markazi", url: "notifications", icon: Inbox },
      ...
      { title: "Xona Tekshiruvi", url: "hr/inspection", icon: ClipboardCheck },
      { title: "Konflikt Hisobotlari", url: "hr/conflict", icon: AlertTriangle },
      ...
      { title: "Anketalar", url: "questionnaire", icon: FileQuestion },
  ...
  tz12: {
    ...
    items: [
      ...
      { title: "Kurs–Karta Biriktiruvi", url: "lms/course-card-binding", icon: Link2 },
      ...
      { title: "LMS Gamifikatsiya", url: "lms/gamification", icon: Trophy },
      ...
      { title: "LMS Yordam (Support)", url: "lms/support", icon: MessageSquare },
      { title: "TAHLIL", url: "", icon: BarChart3, separator: true },
  ...
  tz13: {
    ...
    items: [
      ...
      { title: "Xavfsizlik Dashboard", url: "security", icon: ShieldCheck },
      ...
      { title: "Yuz-Tanish Xodimlar", url: "hr/face-employees", icon: ScanLine },
      { title: "Davomat", url: "security/attendance", icon: UserCheck },
      { title: "Jonli Davomat Monitor", url: "attendance-monitor", icon: UserCheck },
      { title: "Xodim Kuzatuvi", url: "employee-tracking", icon: MapPin },
  ...
  tz15: {
    ...
    items: [
      ...
      { title: "Sensor CAPEX", url: "iot/sensor-capex", icon: HardDrive },
      ...
      { title: "AI Kamera Analitika", url: "europrint/camera-ai-analytics", icon: BrainCircuit },
  ...
  tz16: {
    ...
    items: [
      ...
      { title: "O2C Progress", url: "dashboard/progress", icon: Activity },
      { title: "Ishlab Chiqarish Paneli", url: "director/production", icon: Factory },
      { title: "HR Statistika Paneli", url: "director/hr-stats", icon: Users },
      { title: "Moliya Paneli", url: "director/finance", icon: DollarSign },
      { title: "KPI Paneli", url: "director/kpis", icon: Target },
      ...
      { title: "Kunlik ERP Hisobot", url: "erp-daily-reports", icon: ClipboardList },
      { title: "Oylik Rejalar", url: "director/monthly-plans", icon: CalendarDays },
      { title: "Menejer Kundaligi", url: "director/diary", icon: ScrollText },
      { title: "Me'yoriy Hujjatlar", url: "director/stat-regulations", icon: FileText },
      { title: "KPI Chegaralari", url: "director/kpi-thresholds", icon: Gauge },
      { title: "Kompaniya Holati Config", url: "director/company-state-config", icon: Activity },
      { title: "KPI Vaznlari", url: "director/kpi-weights", icon: Sigma },
      { title: "AI Xulosa", url: "director/ai-summary", icon: BrainCircuit },
      { title: "AI Moslik Baholash", url: "ai/fit-scores", icon: BrainCircuit },
      ...
      { title: "AI Agentlar (Avtomatlashtirish)", url: "ai/agents", icon: BrainCircuit },
      { title: "AI Audit", url: "director/ai-audit", icon: BrainCircuit },
  ...
  tz17: {
    ...
    items: [
      ...
      { title: "Taksonomiya (Ro'yxatlar)", url: "admin/taxonomy", icon: ListOrdered },
      { title: "Tasdiqlash Hub", url: "approvals", icon: CheckCircle },
      { title: "Integratsiyalar", url: "integrations", icon: Link2 },
      { title: "Tizim Audit Log", url: "admin/audit-log", icon: ScrollText },
      { title: "Buyurtmalar Reestri", url: "orders-registry", icon: FileSpreadsheet },
      { title: "STIR/Karta Validator", url: "admin/validate", icon: CheckCircle },
  ...
  coordination: {
    ...
    items: [
      ...
      { title: "Kengash Kvorumi", url: "coordination/quorum", icon: Vote },
      ...
      { title: "Workflow qoidalari", url: "coordination/workflow-rules", icon: Network },
      { title: "AI AGENTLAR", url: "", icon: BrainCircuit, separator: true },
      { title: "AIsha", url: "aisha", icon: Sparkles },
  ...
  knowledgeGraph: {
    title: "Bilim Grafigi",
    icon: Waypoints,
    defaultUrl: "knowledge-graph",
    items: [
      { title: "BILIM GRAFIGI", url: "", icon: Waypoints, separator: true },
      { title: "Grafik Ko'rinishi", url: "knowledge-graph", icon: Waypoints },
    ]
  },
};
