...
const MAIN_NAV: NavSection = {
  ...
  items: [
    ...
    { title: "Kartalar V2",    titleKey: "orgCards",          url: "org/kartalar",            icon: Network         },
    { title: "Razryadlar",     titleKey: "razryadLevels",     url: "org-structure/razryad-levels", icon: Network    },
