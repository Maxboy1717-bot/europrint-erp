...
export const PRODUCT_TYPES = [
  ...
  { value: "laminated", label: "Laminated", labelRu: "Ламинат" },
  { value: "offset", label: "Offset", labelRu: "Офсет" },
  { value: "flexo", label: "Flexo", labelRu: "Флексо" },
...
export const KRASOK_OPTIONS = [
  { value: "1+0", label: "1+0 (1 rang, 1 tomon)" },
  { value: "4+0", label: "4+0 (4 rang, 1 tomon)" },
  { value: "1+1", label: "1+1 (1 rang, 2 tomon)" },
  { value: "2+0", label: "2+0 (2 rang, 1 tomon)" },
  { value: "2+2", label: "2+2 (2 rang, 2 tomon)" },
