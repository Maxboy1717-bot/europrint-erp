...
| Critical-Correctness | 1.2 Duplicate customer payments (SD ledger) | BLOCKED-OWNER-DECISION | n/a | 0% | n/a |
...
| Critical-Correctness | 6.2 hard DELETE orphaned OKR key results | DONE (code); BLOCKED-OWNER-DECISION (84 pre-existing orphaned rows, objective_id=1 doesn't exist) | 4432944 | 100% (code) | Orphaned OKR key results; #9 top-10 |
