...
| Critical-Correctness | `apps/api/src/modules/finance/application/commands/record-payment.handler.ts` (C1: transaction wrap + atomic guarded UPDATE + idempotency key) | claiming now — checked F4 hasn't touched this file yet | in progress |
