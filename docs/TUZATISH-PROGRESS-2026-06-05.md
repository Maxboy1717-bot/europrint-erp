...
⚠️ Keyingi (BOSQICH 2 davomi): EXTERNAL_OUT tannarx legi (2-yozuv Dr 9100/Cr 2810) — multi-leg model keyin. **sales_orders line-items** (vizyon yadrosi, mahsulot katalogi kerak). Payroll proration (biznes-qaror).
