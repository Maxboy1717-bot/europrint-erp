...
| **Legacy (compatibility, general, remaining) ↔ everyone** | **Conformist** (worse: zero translation) | Raw SQL pass-through; no DTO or aggregate boundary | `compatibility/employees-compat.service.ts:37` etc. (PA2-14 pending) |
