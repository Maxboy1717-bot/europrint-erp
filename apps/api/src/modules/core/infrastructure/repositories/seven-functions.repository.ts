/**
 * @module seven-functions.repository
...
import type { ISevenFunctionsRepo } from '../../domain/repositories/i-seven-functions.repo';

type Row = Record<string, unknown>;

@Injectable()
export class SevenFunctionsRepository implements ISevenFunctionsRepo {
