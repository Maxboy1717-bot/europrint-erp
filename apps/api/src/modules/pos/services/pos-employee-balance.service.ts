...
import type { EmployeeInventoryItem }             from '../repositories/pos-employee-balance.repository';

export type { EmployeeInventoryItem } from '../repositories/pos-employee-balance.repository';
