...
import { PosInventoryPassportService } from '../application/services/pos-inventory-passport.service';
import { CreatePassportDto } from '../infrastructure/repositories/pos-inventory-passport.repository';
