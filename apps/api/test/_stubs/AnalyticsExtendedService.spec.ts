...
describe('AnalyticsExtendedService contract', () => {
  it('happy: module exports the class', async () => {
    const mod = await import('../../src/modules/director/analytics/analytics-extended.service');
    expect(mod).toBeDefined();
    expect(mod.AnalyticsExtendedService ?? mod.default).toBeDefined();
  });

  it('error: importing twice returns the same module instance', async () => {
    const a = await import('../../src/modules/director/analytics/analytics-extended.service');
    const b = await import('../../src/modules/director/analytics/analytics-extended.service');
    expect(a).toBe(b);
  });
